...
const EnquiryComponent = () => {
  ...
  const handleSubmit = () => {
    ...
    if (
      enquiryForm.name.length &&
      enquiryForm.contactNumber.length &&
      enquiryForm.maxBudget.length
    ) {
      handleSuccessOpen();
      ...
      <div className={classes.root}>
        {!isMobile && (
          <>
              ...
              >
                <div style={{ width: "49%" }}>
                  ...
                  <CssTextField
                    ...
                    helperText={
                      submitClicked && !enquiryForm.name.length
                ...
                <div style={{ width: "49%" }}>
                  ...
                  <CssTextField
                    ...
                    helperText={
                      submitClicked && !enquiryForm.contactNumber.length
                        ? "This field is required."
                        : ""
                    }
                    InputProps={{
              ...
              >
                <div style={{ width: "49%" }}>
                  ...
                  <CssTextField
                    ...
                    helperText={
                      submitClicked && !enquiryForm.maxBudget.length
                        ? "This field is required."
                        : ""
                    }
                    InputProps={{
            ...
            <div className={classes.whyUsComponent}>
              <WhyUsCardsComponent enquiryForm={true} />
            </div>
          </>
        )}
        {isMobile && (
          <div className={classes.desktopEnquiryForm}>
            ...
            <div>
              ...
              <CssTextField
                ...
                value={enquiryForm.maxBudget}
                onChange={(e) =>
                  setEnquiryForm({ ...enquiryForm, maxBudget: e.target.value })
                }
              />
            </div>
      ...
      <Modal open={openSuccessModal} onClose={handleSuccessClose}>
        <div className={classes.modalStyle}>
          ...
          <div className={classes.heading}>
            Thank you for placing your enquiry, our representative will get in
            touch shortly. Call us on +919591798639 to connect with us
            immediately.
          </div>
        </div>
      </Modal>
